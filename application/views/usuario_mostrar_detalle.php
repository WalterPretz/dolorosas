...
<br>
		...
		<table class="table table-bordered responsive">
			...
			<tbody>
				<tr>
					...
					<td class="text-center"><?php echo $a['cargo']; ?></td>
				</tr>
			</tbody>
		</table>
    <br>
	...
	<hr>
		...
		<div class="row">
			...
			<a class='btn btn-success btn-sm oculalimprimir' style="margin-left: 5px;" data-bs-toggle="modal" data-bs-target="#editar"><i class="fa fa-sync-alt"></i> Editar</a>
