...
<div class="container-fluid">
  <div class="imprimir">
    <div class="row">
      ...
      <div class="col-8">
        <h3 style="margin-top: 25px; text-align: left;">Listado de Incensario Grupo Grande <?php echo date('Y'); ?></h3>
      </div>
    </div>
  </div>
  <div class="container-fluid">
    ...
    <div class="row oculalimprimir">
      <div class="col-12 col-sm-12">
        <h4 class="text-center" style="margin-top: 5px;">Listado de Incensario Grupo Grande <?php echo date('Y'); ?></h4>
      </div>
    </div><br>
    </div>
<section>
...
<section class="saltoDePagina">
  <div class="imprimir">
    <div class="row">
      ...
      <div class="col-8">
        <h3 style="margin-top: 25px; text-align: left;">Listado de Incensario Pequeñas <?php echo date('Y'); ?></h3>
      </div>
    </div>
  </div>
 <h4 class="text-center oculalimprimir" style="margin-top: 5px;">Listado de Incensario Pequeñas <?php echo date('Y'); ?></h4>
 <div class="table-responsive">
    <table class="table-striped table-bordered" width="100%" cellspacing="0" id="cargadoress">
    <thead> 
      <tr>
