...
class Celador_model extends CI_Model{
	...
	function crearCelador($cui, $muni_id_muni, $tipo, $anios, $ofrenda, $descripcion, $cargar){
		$sql = "INSERT INTO colaborador(cui, muni_id_municipio, tipo, estado, anios, ofrenda, descripcion, cargar)
				VALUES (?, ?, ?, ?, ?, ?, ?, ?)";

		$estado = "A";
		$valores = array($cui, $muni_id_muni, $tipo, $estado, $anios, $ofrenda, $descripcion, $cargar);
	...
	function listadoCelador($inicio, $fin){
		$sql = "SELECT a.id_colaborador, b.nombre, b.apellido, b.direccion, c.numero1 as telefono, e.nombre_mun as municipio, d.nombre_depto as departamento
				...
				WHERE 	a.estado = 'A' and a.tipo = 'Celadora' AND a.fecha_registro BETWEEN '$inicio' AND '$fin'
...
//ve a detalle de la persona
	...
	function listadoColaborador($inicio, $fin){
		$sql = "SELECT a.id_colaborador, b.nombre, b.apellido, b.direccion, c.numero1 as telefono, e.nombre_mun as municipio, d.nombre_depto as departamento
				FROM 	colaborador a
				JOIN    persona b on a.id_colaborador = b.col_id_colaborador
				JOIN    telefono c on c.col_id_colaborador = a.id_colaborador
				JOIN    municipio e on e.id_municipio = a.muni_id_municipio
				JOIN    departamento d on d.id_departamento = e.depto_id_depto
				WHERE 	a.estado = 'A' and a.tipo = 'Colaboradora' AND a.fecha_registro BETWEEN '$inicio' AND '$fin'
				ORDER BY a.id_colaborador DESC
				LIMIT 	500";
	...
	function listadoCoordinador($inicio, $fin){
		$sql = "SELECT a.id_colaborador, b.nombre, b.apellido, b.direccion, c.numero1 as telefono, e.nombre_mun as municipio, d.nombre_depto as departamento
				FROM 	colaborador a
				JOIN    persona b on a.id_colaborador = b.col_id_colaborador
				JOIN    telefono c on c.col_id_colaborador = a.id_colaborador
				JOIN    municipio e on e.id_municipio = a.muni_id_municipio
				JOIN    departamento d on d.id_departamento = e.depto_id_depto
				WHERE 	a.estado = 'A' and a.tipo = 'Coordinadora' AND a.fecha_registro BETWEEN '$inicio' AND '$fin'
				ORDER BY a.id_colaborador DESC
				LIMIT 	500";
	...
	function listadoCeladorHonor($inicio, $fin){
		$sql = "SELECT a.id_colaborador, b.nombre, b.apellido, b.direccion, c.numero1 as telefono, e.nombre_mun as municipio, d.nombre_depto as departamento
				FROM 	colaborador a
				JOIN    persona b on a.id_colaborador = b.col_id_colaborador
				JOIN    telefono c on c.col_id_colaborador = a.id_colaborador
				JOIN    municipio e on e.id_municipio = a.muni_id_municipio
				JOIN    departamento d on d.id_departamento = e.depto_id_depto
				WHERE 	a.estado = 'A' and a.tipo != 'Sistema' and a.cargar = 'Honor Salida' AND a.fecha_registro BETWEEN '$inicio' AND '$fin'
				ORDER BY a.id_colaborador DESC
				LIMIT 	500";
