...
<br>
	...
	<hr>
	<div class="imprimir">
		<p class="h6">Totonicapán, Totonicapán, <?php echo date('d/m/Y h:i:s a' ); ?></p>
	</div>
	<div class="row">
		<div>
			<a class='btn btn-primary btn-sm oculalimprimir' href = "javascript:history.back()"><i class="fa fa-sign-out-alt"></i> Salir</a>
		</div>
		<div>
			<?php if ($a['tipo'] != '----') { ?>
			<a class='btn btn-success btn-sm oculalimprimir' style="margin-left: 5px;" data-bs-toggle="modal" data-bs-target="#editar"><i class="fa fa-sync-alt"></i> Editar</a> <?php  	} ?>
		</div>
		<div>
