      ...
      <tbody>
         <?php foreach ($arr as $a){ ?>
            <tr>
              ...
              <td class="text-center oculalimprimir"><a class='btn btn-warning btn-sm botones' style="color: #fff;" data-bs-toggle="modal" data-bs-target="#cambiar" 
...
<!-- Modal -->
<div class="modal fade" id="cambiar" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
