							...
							<form class="needs-validation" id="registrar_usuario" name="registrar_usuario" method="POST">
								...
								<div class="row">
									<div class="col-sm-4 col-md-4 col-lg-4">
										...
										<input type="text" class="form-control form-control-user integer" id="cui" placeholder="CUI del DPI" name="cui" maxlength="13" value="0" required> <div class="valid-feedback">Correcto!</div>
									</div>
									<div class="col-sm-4 col-md-4 col-lg-4">
									...
									<div class="col-sm-4 col-md-4 col-lg-4">
										...
										<input type="text" class="form-control form-control-user integer" placeholder="Teléfono" name="telefono2" id="telefono2" value="0" maxlength="8"> <div class="valid-feedback">Correcto!</div>
									</div>
								</div>
								<br>
								<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-4 col-md-4 col-lg-4">
										...
										<select id="rol"class="custom-select form-control" name="rol" required>
