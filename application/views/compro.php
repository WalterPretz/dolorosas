        ...
        <div class="caja letra">
          <div class="row">
            ...
            <div class="col-sm-2 col-2">
              ...
              <h4 class="text-center" style="color: red; font-weight:bold;">No. <?php echo $a['recibo'] ;?></h4>
            </div>
          </div>
          <br>
          <?php
          ...
          <div class="row form-row forma">
            ...
            <div class="col-3 col-md-3 raya"><h5 class="centra">SOCIO: </strong></h5></div>
          </div>
          <div class="row form-row forma" style="margin-top: 5px">
            ...
            <div class="col-3 col-md-3 raya"><h5 class="centra text-center"><?php echo $a['tipo'] ;?></h5></div>
          </div>
          <div class="row form-row forma" style="margin-top: 5px">
...
<center>
  <div class="row container">
    <div class="col-4 col-sm-4"><button class="btn btn-sm btn-primary botones oculalimprimir" id="imprimir" type="button">Imprimir</button></div>
    <div class="col-4 col-sm-4"><a href="<?=$base_url?>/celador" class="btn btn-sm btn-success botones oculalimprimir" > Otra Inscripción<i class="fa fa-user"></i></a></div>
    <div class="col-4 col-sm-4"><a href="<?=$base_url?>/inicio" class="btn btn-sm btn-info botones oculalimprimir" > Salir <i class="fa fa-door-open"></i></a></div>
  </div>
</center>
