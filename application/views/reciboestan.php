      ...
      <div class="escudo">
        <div class="caja letra">
          ...
          <div class="row form-row forma" style="margin-top: 5px">
            ...
            <div class="col-sm-3 col-md-3 raya"><h5 class="centra text-center"><?php echo $a['tipo'] ;?></h5></div>
          </div>
          <div class="row form-row forma" style="margin-top: 5px">
...
<center>
  <div class="row container-fluid">
    ...
    <div class="col-sm-3"><a href="<?=$base_url?>/cargador/inscripcionines" class="btn btn-sm btn-success botones oculalimprimir" > Inscripción <i class="fa fa-user"></i></a></div>
