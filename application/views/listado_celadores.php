...
<br>
  <center>
  <h3 style="color: #03064A"><i class="fa fa-clipboard-list"></i> Listado de Celadores</h3></center>
<br>
<section>
         ...
         ?>
          ...
          <tr>
            ...
            <td class="text-center oculalimprimir"><a class='btn btn-danger btn-sm botones' style="color: #fff;" data-bs-toggle="modal" data-bs-target="#eliminar" 
              onclick="obdatosIdPerso('<?php echo $a['id_colaborador'] ;?>')"><i class="fa fa-trash-alt"></i></a></td>
          </tr>
         <?php
            }
          ?>
